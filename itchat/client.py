...
class client:
    ...
    def auto_login(self):
        ...
        while True:
            ...
            if status == '200':
                ...
                out.print_line('Reloading QR Code', True)
                open_QR()
        self.web_init()
    ...
    def show_mobile_login(self):
        ...
        self.s.post(url, data=json.dumps(BytesDecode(payloads)), headers=headers)
            ...
            if m['MsgType'] == 1:  # words
                ...
                if m['AppMsgType'] == 6:
                    def download_atta(attaDir):
                        ...
                        url = 'https://file%s.wx.qq.com/cgi-bin/mmwebwx-bin/webwxgetmedia' % (
    ...
    def __produce_group_chat(self, msg):
        ...
        try:
            ...
            self.storageClass.groupDict[msg['FromUserName']] = {member['UserName']: member for member in
                                                                groupMemberList}
    ...
    def add_member_into_chatroom(self, chatRoomName, memberList):
        ...
        self.s.post(url, data=json.dumps(BytesDecode(params)), headers=headers)
